  ...
  stack: [
    {
      ...
      { highlighted: true, tool: Technologies.AZURE_STORAGE },
      { highlighted: true, tool: Technologies.ENTRA_ID },
      { highlighted: false, tool: Technologies.POSTGRESQL },
      { highlighted: false, tool: Technologies.REDIS },
    ...
    },
    {
      ...
      { highlighted: true, tool: Technologies.AZURE_FUNCTIONS },
      ],
    },
    {
    ...
    },
    {
      ...
      { highlighted: true, tool: Technologies.HTML_CSS },
      { highlighted: true, tool: Technologies.TAILWIND },
